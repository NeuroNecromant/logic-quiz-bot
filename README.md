...
<strong>Как пользоваться:</strong>
 ...
 🔻Для того, чтобы отобразить кнопки и вывести приветственное сообщение, напишите <strong>"/start"</strong>
 
 🔻Для того, чтобы начать квиз напишите <strong>"/quiz"</strong>
 
 🔻Для того, чтобы узнать рейтинг игроков, напишите <strong>"/rate"</strong>
